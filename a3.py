...
def main() -> None:
    ...
    r_org = 36000 + earth_rad                            # Circular orbit
    inc_ang_org, raan_org = 33.42, 352                 # Inclination angle and Right Angle of Ascending Node of original orbit
    ...
    inc_ang_1, raan_1, eccentricity_1, arg_perigee_1, \
        mean_anomaly_1, mean_motion_1 = lc.deduce_tle("Orbit_TLEs/TDRS3.txt")
    ...
    inc_ang_2, raan_2, eccentricity_2, arg_perigee_2, \
        mean_anomaly_2, mean_motion_2 = lc.deduce_tle("Orbit_TLEs/TDRS6.txt")
    ...
    inc_ang_3, raan_3, eccentricity_3, arg_perigee_3, \
        mean_anomaly_3, mean_motion_3 = lc.deduce_tle("Orbit_TLEs/TDRS7.txt")
